// src/app/admin/components/howitworks/components/HowItWorksForm.js
"use client";

import { useState, useEffect } from "react";

export default function HowItWorksForm({ content, onSubmit }) {
    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end">
          ...
          >
            {saving ? 'Saving...' : 'Update How It Works Content'}
          </button>
        </div>
      </form>
    </div>
