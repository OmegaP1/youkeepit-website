// src/app/company/page.js - UPDATE THIS FILE
'use client';
...
export default function CompanyPage() {
  ...
  const loadCompanyData = async () => {
    try {
      ...
      // Check authentication and get company context
      const storedAuth =
      ...
      try {
        const dashboardResponse = await fetch(
          `/api/company/${user.company_slug}/dashboard`,
          {
            credentials: 'include',
          }
        );
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Welcome back, {companyData.user?.first_name}! Here's your company
              overview.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  $
                  {dashboardStats.stats?.additionalMetrics?.thisMonthRevenue?.toLocaleString() ||
                    '0'}
                </p>
              </div>
            </div>
